" Floating-window command runner: shows g:menu_commands (set from
" lua/custom/menu/menu.lua) as a checklist, runs the selected command as a
" background job, and lets you toggle/inspect its output.
let g:menu = {
      \ 'checkbox_col_pos': 6,
